...
import org.opensearch.commons.alerting.model.destination.EmailAccount
import org.opensearch.commons.alerting.model.destination.Recipient
...
//                }
                ...
                DestinationType.EMAIL -> {
                    ...
                    alertEmail.recipients.forEach {
                        ...
                        else it.email?.let { emailRecipient -> recipients.add(Recipient(it.type, emailRecipient, null)) }
                    }

                    val email = org.opensearch.commons.alerting.model.destination.Email(alertEmail.emailAccountID, recipients)
        ...
        fun convertEmailGroupToNotificationConfig(
                emailGroup: org.opensearch.commons.alerting.model.destination.EmailGroup
        ): NotificationConfig {
