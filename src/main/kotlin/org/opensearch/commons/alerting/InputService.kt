...
import org.opensearch.commons.alerting.util.AggregationQueryRewriter
import org.opensearch.commons.alerting.util.addUserBackendRolesFilter
import org.opensearch.commons.alerting.util.executeTransportAction
import org.opensearch.commons.alerting.util.toMap
import org.opensearch.commons.core.model.ClusterMetricsInput
import org.opensearch.commons.core.model.SearchInput
...
class InputService(
    ...
    suspend fun collectInputResultsForADMonitor(monitor: Monitor, periodStart: Instant, periodEnd: Instant): InputRunResults {
        return try {
            ...
            client.threadPool().threadContext.stashContext().run {
