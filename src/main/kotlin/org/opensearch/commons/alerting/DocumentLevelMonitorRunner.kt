...
import org.opensearch.commons.alerting.alerts.AlertIndices.Companion.FINDING_HISTORY_WRITE_INDEX
import org.opensearch.commons.alerting.model.*
import org.opensearch.commons.alerting.model.AlertingConfigAccessor.Companion.getMonitorMetadata
import org.opensearch.commons.alerting.model.action.PerAlertActionScope
import org.opensearch.commons.alerting.script.DocumentLevelTriggerExecutionContext
import org.opensearch.commons.alerting.util.AlertingException
import org.opensearch.commons.alerting.util.defaultToPerExecutionAction
import org.opensearch.commons.alerting.util.getActionExecutionPolicy
import org.opensearch.commons.alerting.util.updateMonitorMetadata
import org.opensearch.commons.core.model.DocLevelMonitorInput
import org.opensearch.commons.core.model.DocLevelQuery
import org.opensearch.commons.core.model.ScheduledJob
import org.opensearch.commons.opensearchapi.string
    ...
    private suspend fun runForEachDocTrigger(
        ...
        if (!dryrun && monitor.id != Monitor.NO_ID) {
            val updatedAlerts = alerts.map { alert ->
                val actionResults = triggerResult.actionResultsMap.getOrDefault(alert.id, HashMap())
