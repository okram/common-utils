...
import org.opensearch.commons.alerting.model.AlertingConfigAccessor
import org.opensearch.commons.alerting.settings.DestinationSettings
...
class DestinationContextFactory(
        ...
        private var destinationSettings: Map<String, DestinationSettings.Companion.SecureDestinationSettings>
) {

    fun updateDestinationSettings(destinationSettings: Map<String, DestinationSettings.Companion.SecureDestinationSettings>) {
    ...
    suspend fun getDestinationContext(destination: Destination): DestinationContext {
        ...
        if (destination.type == DestinationType.EMAIL) {
            ...
            val uniqueListOfRecipients = getUniqueListOfEmailRecipients(email).map { s -> EmailRecipient(s) }
