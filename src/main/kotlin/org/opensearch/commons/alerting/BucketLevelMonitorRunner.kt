...
import org.opensearch.commons.alerting.script.BucketLevelTriggerExecutionContext
...
import org.opensearch.commons.alerting.util.getCombinedTriggerRunResult
    ...
    override suspend fun runMonitor(
        ...
        for (trigger in monitor.triggers) {
            ...
            val updatedAlerts = alertsToUpdate.map { alert ->
                ...
                val actionResults = triggerResult.actionResultsMap.getOrDefault(bucketKeysHash, java.util.HashMap<String, ActionRunResult>())
